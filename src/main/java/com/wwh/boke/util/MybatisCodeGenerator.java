...
/**
* @Description:    Mybatis-plus 自动代码构造器
* @Author:         wangwenhu
* @CreateDate:     2020/9/25  15:32
* @UpdateUser:     修改人 修改时更新
* @UpdateDate:     2020/9/25  15:32
...
public class MybatisCodeGenerator {
    ...
    private static final String dataPwd = "Mysql123$";
    private static final String dataUrl = "jdbc:mysql://localhost:3306/blog?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&characterSetResults=utf8";
    private static final String driverName = "com.mysql.cj.jdbc.Driver";
    private static final String parentPackage = "com.wwh.boke";
