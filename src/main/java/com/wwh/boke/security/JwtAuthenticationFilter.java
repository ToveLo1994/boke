...
/**
* @Description:    定义一个过滤器，用来处理用户登录，用户信息的保存，使用JWT，
*                  在用户验证成功后，返回信息中添加JWT， JWT将使用redis进行缓存。
* @Author:         wangwenhu
* @CreateDate:     2020/9/27 0027 15:18
* @UpdateUser:     修改人 修改时更新
* @UpdateDate:     2020/9/27 0027 15:18
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    /**
     * 过滤器一定要设置 AuthenticationManager，这里的 AuthenticationManager
     * 从 Security 配置的时候传入
    */
